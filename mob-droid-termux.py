...
#YouTube     Hrijulop
#Instagram   Hrijulop
#Website     https://hrijulop.wordpress.com/
...
def head():
    ...
    print'''{0}
       ...
       *****    Mob-Droid   *****
{2}Follow me :{3}
{1}•{3} GitHub : {4}https://github.com/Hrijulop{3}
{1}•{3} YouTube: {4}https://www.youtube.com/Hrijulop{3}
{1}•{3} Website: {4}hrijulop.wordpress.com{3}
